...
export const getLeaderboard = () => client.get('/dashboard/leaderboard').then(r => r.data)
export const getChildStats = (childId) => client.get(`/dashboard/stats/${childId}`).then(r => r.data)